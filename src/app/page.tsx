      ...
      <PageContainer className="space-y-6">
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          <SectionCard
            ...
            description="Current operational movement for patient flow teams."
            action={<StatusBadge label="Live Preview" status="info" />}
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-lg bg-secondary p-4">
                <div>
                  <p className="text-sm font-medium">Reception Queue</p>
                  <p className="mt-1 text-sm text-muted-foreground">11 patients waiting, 2 called</p>
                </div>
                <StatusBadge label="Active" status="success" />
              </div>
              <div className="flex items-center justify-between rounded-lg border border-dashed p-4">
                <div>
                  <p className="text-sm font-medium">Urgent Care Queue</p>
                  <p className="mt-1 text-sm text-muted-foreground">Fast lane for high-priority check-ins.</p>
                </div>
          ...
          <SectionCard
            ...
            description="Placeholder panel for future booking and slot insights."
            action={<StatusBadge label="Planned" status="info" />}
          >
            <div className="space-y-4">
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">82% slot utilization today</p>
                  </div>
                  <Activity className="h-5 w-5 text-primary" />
                </div>
              </div>
              <div className="rounded-lg bg-secondary p-4 text-sm text-muted-foreground">
                Charts and live scheduling analytics will plug into this reusable panel later.
              </div>
            </div>
          </SectionCard>
        </section>
